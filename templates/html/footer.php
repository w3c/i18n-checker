	<ul id="menu">
			...
			<li><a href="<?php echo Conf::get('base_uri'), 'versions', Conf::get('show_extension') ? '.php' : '' ?>" title="<?php _lang('footer_version_title') ?>"><?php _lang('footer_version') ?></a></li>
	</ul>
	...
	<div id="footer">
		<div class="leftCol w3cLargeLogo">
			<p id="activity_logos">
				<a class="w3cLarge" href="https://www.w3.org/International/"><span>W3C Internationalization Activity</span></a>
			</p>
		</div>
		
		<p id="support_logo">
			<a href="https://www.w3.org/QA/Tools/Donate" title="Validators Donation Program">
		...
		<p class="copyright" xml:lang="en" lang="en" dir="ltr">
			<a rel="Copyright" href="https://www.w3.org/Consortium/Legal/ipr-notice#Copyright">Copyright</a> &copy; 2013-2016
